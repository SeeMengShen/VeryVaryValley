...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        //Extra action boolean for trigerring Animator
        private bool moving;
        ...
        private void Start()
        {
            ...
            thirdPersonView = m_Camera.transform.localPosition;
        }
        ...
        private void UpdateCameraPosition(float speed)
        {
            ...
            if (!m_UseHeadBob)
            {
                m_Camera.transform.localPosition = thirdPersonView;
                return;
            }
            else//(m_CharacterController.velocity.magnitude > 0 && m_CharacterController.isGrounded)
            {
                ...
                newCameraPosition.z = m_Camera.transform.localPosition.z + 0.5f;
